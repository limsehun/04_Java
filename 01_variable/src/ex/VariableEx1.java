...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		 ...
		 * byte  (1byte)
		 * short (2byte)
		 * int   (4byte) - 정수 기본형(123 -> int로 인식)
		 * long  (8byte) - 숫자 뒤에 l또는 L붙임(123l)
		 * 
		 * -실수형-
		 * float  (4byte) 숫자 뒤에 f 또는 F (3.14f)
		 * double (8byte) 
		 * 
		 * -문자형-
		...
		//변수선언 : 메모리에 값을 저장할 공간을 만듦(==할당)
		
		int num1; // 메모리에 int형 데이터를
		 ...
		 * byte 크기가 floatdml 2배라서 double이 아님
		 * 
		 * 정확도가 2배
