...
public class PrintEx {
	...
	public static void main(String[] args) {
		...
		double  height 	  = 215.5;   // (실수 기본형, 8byte)
		char    gender 	  = '남';      // (문자형, 2byte)
		boolean javaStudy = true; 	  // (논리형, 1byte)
		
		// 홍길동은 25세 남성으로 키는215.5cm 이고, 자바 공부여부 true
		...
		// printf() 버전
		System.out.printf("소개 : %s은 %d세 %c성으로 키는 %fcm 이고, 자바 공부여부 : %b",
		...
		// 문자열 6칸 왼쪽정렬 : %-6s
		System.out.println(); // 줄바꿈
		System.out.printf("%-6s/%f",name, height); //홍길동ㅁㅁㅁ/215.0000 
