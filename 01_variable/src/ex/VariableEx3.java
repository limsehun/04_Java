...
public class VariableEx3 {
	...
	System.out.println("[강제 형변환 데이터 손실 확인]");
	
	int num1 = 290;
	byte result1 = (byte)num1; //byte강제변환
	
	System.out.println("num1 : "+num1 ); //290
	System.out.println("result1 : "+result1 ); //34
	
	System.out.println("-----------------------------------");
	System.out.println("[강제 형변환 데이터 손실 확인2]");
	...
	System.out.println("임 번호 : "+(int)'임'); //51076
	System.out.println("세 번호 : "+(int)'세'); //49464
	System.out.println("훈 번호 : "+(int)'훈'); //54984
	
	System.out.println("ㄱ 번호 : "+(int)'ㄱ'); //12593
	
	// int -> char
	System.out.println("ㄱ의 다음은? : " + (char)('ㄱ'+1));
	System.out.println("ㄱ + 2는? : " + (char)('ㄱ'+2));
	System.out.println("ㄱ + 3는? : " + (char)('ㄱ'+3));
