...
public class FileService {
	...
	public void test3() {
		...
		// C:\Users\tpgns\OneDrive\Desktop\workspace\04_java\11_io
		File project = new File("C:\\Users\\tpgns\\OneDrive\\Desktop\\workspace\\04_java\\11_io");
		...
		for(File f : files) {
			...
			// SimpleDateFormat : 간단히 날자 형식을 지정할 수있는 기능을 제공하는 클래스
			// y : year (연도)
			// M : month (월)
			// d : day   (일)
			// a : am/pm (오전, 오후)
			...
			// 출력할 문자열
			String result
				= String.format("%-20s %-20s %-5s %-10s", fileName, date, type, kb ==null? "" : kb);
