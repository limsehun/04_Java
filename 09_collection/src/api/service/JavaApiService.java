...
public class JavaApiService {
	...
	public void test1() {
		...
		// s가 참조하는객체의 값을 변경
		s += "World";
		System.out.println("변경후 String : "+System.identityHashCode(s));
	...
	public void test2() {
		...
		String s1 = "Hello"; //1221555852 (상수풀 생성)
		System.out.println("s1 : " + System.identityHashCode(s1));

//		String s2 = s1;
		String s2 = "Hello"; //1221555852 (상수풀 재활용)
		System.out.println("s2 : " + System.identityHashCode(s2));
		
		// 같은 값을 지닌 String을 new연산자를 이용해 생성
		String s3 = new String("Hello"); //783286238 (Heap 새로 생성)
		...
		// == s1, s3의 주소값이 다르기 때문에 비교연산시 무조건 false
	...
	public void test3() {
		...
		// StringBuilder는 내부 필드에 문자열을 추가해 누적하는 방식
	...
	public void test4() {
		...
		System.out.println("-------------------------");
		//System.out.println(sb.toString());(임시확인용)
		
		// StringBuilder에 누적된 문자열을 String 형태로 반환
		String input = sb.toString();
		
		// 1) String[] 문자열.split("구분자")
		// - 문자열을 "구분자"를 기준으로 나누어 String[]형태로 반환
