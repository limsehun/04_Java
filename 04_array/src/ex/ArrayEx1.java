...
public class ArrayEx1 {
	...
	public void method1() {
		...
		// -> 변수를 이용해 생성된 배열을 참조할 수 있다.
		
		//배열 초기화
		// -> 배열 요소에 값 대입
		
		//1) 배열을 생성 하자마자
		//   각 칸에는 무슨 값이 저장되에 았을까?
		//	각 자료향의 기본값이 저장되어  있음
	...
	public void method2() {
		...
		// java.util.Arrays 클래스 : 배열의 유영한 기능을 모아둔 클래스
